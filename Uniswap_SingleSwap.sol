//First deploy the Single Swap contract via Hardhat. Then you can interact with the contract through Remix IDE.
//This code was used for a tutorial via Block Explorer Youtube channel. Video link: https://youtu.be/GwMyv7CmoRs
